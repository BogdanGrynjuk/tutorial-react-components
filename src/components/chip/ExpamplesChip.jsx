...
const ExpamplesChip = () => (
  <>
    ...
    <h2><span>2. Chip з довгим текстом:</span></h2>
    <Chip text="Дуже довгий текст Chip повинен бути обрізаний" />

    <h2><span>3. Chips з іконкою та кнопкою закриття:</span></h2>
    ...
    <h2><span>5. Chip з зображенням:</span></h2>
    ...
    <h2><span>6. Chip з діями на body та іконці закриття:</span></h2>
    <Chip
      text="React"
      withImage
      imageSrc={react}
      imgAlt="react"
      onChipClick={() => { console.log('натиснуто на chip body'); }}
      withClose
    />
    <Chip
      text="Angular"
      ...
      imageSrc={angular}
      imgAlt="angular"
      onCloseClick={() => { console.log('натиснуто на іконку закриття'); }}
      withClose
    />
    <Chip
      text="Vue"
    ...
    <h2><span>7. Приклад використання:</span></h2>
    <UsageExampleChip />
  </>
);
