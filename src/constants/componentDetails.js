...
export const TOOLTIP = {
  ...
  description:
    'Tooltip є багаторазовим елементом користувацького інтерфейсу, який відображає спливаючу підказку при наведенні миші на елемент. Компонент автоматично визначає оптимальне розташування підказки залежно від наявного простору на екрані.',
  usage: [
    {
      title: 'Відображення підказок',
      content:
        'Використовуйте Tooltip для надання додаткової інформації або пояснень при наведенні миші на елемент. Це може бути корисно для пояснень кнопок, іконок або інших елементів інтерфейсу.',
    },
    {
      title: 'Автоматичне позиціонування',
      content:
        'Tooltip автоматично визначає найбільш зручне місце для відображення підказки (зверху, знизу, зліва або справа) залежно від наявного простору на екрані. Це допомагає уникнути перекриття підказки важливим контентом.',
    },
    {
      title: 'Кастомізація стилю',
      content:
        'Ви можете змінювати стиль підказки, передаючи кастомні CSS стилі через властивість style. Це дозволяє налаштувати вигляд підказки відповідно до стилю вашого додатка.',
    },
    {
      title: 'Управління видимістю',
      content:
        'Tooltip відображається при наведенні миші на цільовий елемент і ховається при відведенні миші. Ви можете керувати видимістю підказки за допомогою обробників подій onMouseEnter і onMouseLeave.',
    },
  ],
};
...
export const MODAL = {
  ...
  description:
    'Modal є багаторазовим елементом користувацького інтерфейсу, який використовується для відображення вікна поверх основного контенту вашого веб-додатку. Він підтримує закриття за допомогою клавіші Escape, натискання на фон, і дозволяє передавати будь-який контент всередині модального вікна.',
  usage: [
    {
      title: 'Відображення контенту поверх сторінки',
      content:
        'Використовуйте Modal для відображення важливого контенту, який потребує уваги користувача, такого як форми, повідомлення або інші інтерактивні елементи.',
    },
    {
      title: 'Керування видимістю',
      content:
        'Modal можна закривати натисканням клавіші Escape або кліком по фоні. Це допомагає користувачам легко закрити модальне вікно і повернутися до основного контенту.',
    },
    {
      title: 'Передача дочірнього контенту',
      content:
        'Передавайте будь-який контент через властивість `children`, щоб налаштувати вигляд та функціональність модального вікна відповідно до ваших потреб.',
    },
    {
      title: 'Кастомізація стилю',
      content:
        'Ви можете додати власні стилі до модального вікна і фону через класи CSS, щоб адаптувати його під дизайн вашого додатку.',
    },
  ],
};
